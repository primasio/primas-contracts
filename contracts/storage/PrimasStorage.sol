...
/// @title The primary persistent storage for Primas

contract PrimasStorage is Ownable {
    ...
    /// @dev Only allow access from the latest version of a contract in the Primas after deployment
    modifier onlyLatestPrimasContract() {
